                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                <li class="nav-item">
                                    <a class="navbar-brand d-flex align-items-center" href="profile.php">
                                        <img src="resources/avater.png" alt="Your Photo" style="width:40px;"
                                            class="rounded-pill me-3">
                                        <h5 class="name" style="line-height: 40px; margin: 0;">Shahriar Rahman Niloy
                                        </h5>
                                    </a>
                                </li>
                            </ul>
        ...
        <div class="user_dashboard_container">
            ...
            <div class="rated_students_list">
                ...
                <div class="buttons">
                    ...
                    <button type="button" class="btn mt-2 ques-up" data-bs-toggle="modal"
                                    ...
                                    <form class="signup_form" action="#" autocomplete="off">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="trimesterCode"
                                                    id="inlineRadio1" value="231">
                                                <label class="form-check-label" for="inlineRadio1">Spring 2023</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="trimesterCode"
                                                    id="inlineRadio2" value="232">
                                                <label class="form-check-label" for="inlineRadio2">Summer 2023</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="trimesterCode"
                                                    id="inlineRadio3" value="233">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary">Upload <i
